<div class="row">
  <div class="col-xs-12">
    <h1 class="title">Current and future features</h1>
  </div>
</div>
...
<div class="row">
  <div class="col-xs-12">
    ...
    <ul>
      <li style="text-decoration:line-through">Show price ranges instead of one price</li>
      <li style="text-decoration:line-through">Add more source languages</li>
